...
<!-- Este sera el contenido principal de la carpeta. Usamos codigo html, php laravel e incluimos cdn de Bootstrap para elementos, iconos, demas. -->
@section('content')
...
<!-- Manipulamos estilos de Bootstrap para nuestra conveniencia en el propyecto -->
    <style>
        .card {
            border-radius: 8px;
